      ...
      <h2 className="fw-bold text-body-emphasis p-2 my-4" style={{textAlign:'center',fontFamily:'-moz-initial',backgroundColor:'skyblue',borderRadius:'15px' ,boxShadow:'rgba(0, 0, 0, 0.24) 0px 3px 8px'}} >Education</h2>
        ...
        <div class="container my-5 "   >
          <div class="p-5 text-center rounded-3" data-aos="fade-up" style={{backgroundColor:'#051622'}}>
            ...
            <h3 data-aos="zoom-in" className="text-white" >Bachelor of Technology</h3>
            <p class="lead text-white" data-aos="zoom-in" >
        ...
        <div class="container my-5" id="edubox" >
          <div class="p-5 text-center  rounded-3" data-aos="fade-up" style={{backgroundColor:'#051622'}}>
            ...
            <h3 data-aos="zoom-in" className="text-white">Completion of Board of Intermediate Public Examination</h3>
            <p class="lead text-white"  data-aos="zoom-in" >
        ...
        <div class="container" id="edubox" >
          <div class="p-5 text-center  rounded-3" data-aos="fade-up" style={{backgroundColor:'#051622'}}>
            ...
            <h3 data-aos="zoom-in" className="text-white" > Completion of Board of Secondary School Certificate </h3>
            <p class="lead text-white" id="edubox" data-aos="zoom-in" >
